...
function App() {
  ...
  const renameCategories = (catId,categories) => categories.find(cat => cat.id === catId)
      ...
      .then(data => {
        ...
        const items = data.results.map(item => {
          return {
            ...
            category: renameCategories(item.category_id,ML_CATEGORIES_LIST).name
          }
        })
        setItemList(items)
      })
